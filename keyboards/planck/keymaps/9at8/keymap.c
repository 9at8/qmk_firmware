 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn 1 | Ctrl | Gui  | Alt  |  NUM |    Space    |  NAV | Ctrl | Alt  | Gui  |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSHFT_ENT,
    FN1,     KC_LCTL, KC_LGUI, KC_LALT, NUM,     KC_SPC,  KC_SPC,  NAV,     KC_RCTL, KC_RALT, KC_RGUI, XXXXXXX
),
 ...
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn 1 |      |      |      |MC_NUM|             |MC_NAV| Gui  | Alt  | Ctrl |      |
 * `-----------------------------------------------------------------------------------'
 */
[_MAC] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    MC_FN1,  _______, _______, _______, MC_NUM,  _______, _______, MC_NAV,  KC_RGUI, KC_RALT, KC_RCTL, _______
),
...
[_NAV] = LAYOUT_planck_grid(
    ...
    _______, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,
...
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_INS,  KC_PSCR,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  XXXXXXX, XXXXXXX, QWERTY,  MAC,      _______, _______, _______,
